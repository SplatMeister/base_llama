...
if uploaded_files:
    ...
    # Define the conversational chain (integration of provided code snippet)
    questionPrompt = lambda context: context['question']
    st.session_state.chain = RunnableSequence.from([
        questionPrompt,
        model,
        StringOutputParser(),
    ])
